...
public class AutomationConfig implements Serializable {
	...
	private Map<String, LifeCycleConfig> lifeCycleConfig = new LinkedHashMap<String, LifeCycleConfig>();
	
	public void addLifeCycleConfig(LifeCycleConfig lifeCycle)
	{
		lifeCycleConfig.put(lifeCycle.getName(), lifeCycle);
	}
	...
	public ExceptionMapperConfig getExceptionMappersConfig() {
		return exceptionMappersConfig;
	}

	public void setExceptionMappersConfig(
			ExceptionMapperConfig exceptionMappersConfig) {
		this.exceptionMappersConfig = exceptionMappersConfig;
	}
}
