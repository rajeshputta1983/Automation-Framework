...
package com.codesnippets4all.automationframework.core.exceptions;
...
public class AutomationConfigException extends RuntimeException {
	...
	public AutomationConfigException(String msg){
		super(msg);
	}
	
	public AutomationConfigException(String msg, Throwable t){
		super(msg, t);
	}
	
	public AutomationConfigException(Throwable t){
		super(t);
	}
}
