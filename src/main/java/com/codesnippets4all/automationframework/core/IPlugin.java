...
package com.codesnippets4all.automationframework.core;
...
public interface IPlugin {
	TaskStatus process(Map<String, String> configuration, IContext context, TaskStatusManager taskStatusManager);
}
